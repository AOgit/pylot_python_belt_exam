...
routes['/home'] = 'Users#show'
routes['/logout'] = 'Users#logout'
routes['POST']['/add'] = 'Users#create_quote'
routes['POST']['/remove/<id>'] = 'Users#remove_fav'
routes['POST']['/add_to_favorites/<id>'] = 'Users#get_fav'
routes['/profile/<id>'] = 'Users#show_profile'
